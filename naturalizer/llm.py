...
_SYSTEM_PROMPT = (
    "You are a skilled copy editor. Rewrite the user's draft so it reads like "
    "it was written by a thoughtful human. Keep the meaning, facts, and "
    "structure; improve the prose. Break up mechanical sentence patterns, "
